	...
	<div class="mainBox pro-list-body clearfix" id="rollingLayer">
	  ...
	  <table class="page_bar">
		...
		<tr>
			...
			<c:otherwise>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?productType=${productType}">首页</a>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?productType=${productType}&currentPage=${currentPage-1}">上一页</a>
			</c:otherwise>
			</c:choose>
			...
			<c:otherwise>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?productType=${productType}&currentPage=${currentPage+1}">下一页 </a>
				<a id="lnkNext" href="${pageContext.request.contextPath}/loan/loan?productType=${productType}&currentPage=${totalPage}">尾页</a>
			</c:otherwise>
			</c:choose>
			</td>
		</tr>
