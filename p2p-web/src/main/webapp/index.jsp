...
<div class="brand-promotion">
    ...
    <div class="mainBox">
        ...
        <div class="jinxin-data">
            ...
            <div class="line"></div>
            <h3>累计成交额</h3>
            <div class="data"><span id="hzxx_ljje">${totalBidMoney}</span>元</div>
        </div>
    </div>
</div>
<!--品牌宣传end-->
...
<div id="productArea">
	...
	<div class="mainBox pro-body clearfix">
		...
		<c:forEach items="uLoanInfoList" var="uloanInfo">
			...
			<div class="pro-box <c:if test='${uloanInfo.leftProductMoney eq 0}'> pro-full</c:if>">
				...
				<div class="pro-main">
					<div class="pro-rate">
						<div class="rate">${uloanInfo.rate}<span>%</span>
						</div>
						<h3>历史年化收益率</h3>
					</div>
	...
	<div class="mainBox pro-body disperse-pro clearfix">
	  	<div class="new-pro-icon"><img src="images/new-pro-icon.png"/></div>
		   <c:forEach items="${sLoanInfoList}" var="sLoanInfo" varStatus="sLoanInfoStatus">
			   <!--:已满标时追加pro-full-->
			   <div class="pro-box" <c:if test='${sLoanInfo.leftProductMoney eq 0}'> pro-full</c:if>">
				...
				<c:if test="${sLoanInfoStatus.count eq 4}">
					<!-- 4个一组，分隔线 -->
